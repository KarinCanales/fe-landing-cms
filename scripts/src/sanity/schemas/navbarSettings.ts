  ...
  fields: [
    {
      ...
      options: {
        ...
        ...fieldHelp({
          helpText: 'Los botones del menú y el botón de WhatsApp están fijos y no se pueden editar aquí. El WhatsApp se toma del campo “WhatsApp principal” de Datos generales.',
