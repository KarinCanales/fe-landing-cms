      ...
      of: [
        {
          ...
          fields: [
            ...
            },
            {
              ...
              type: 'string',
              description: 'Texto pequeño que agrupa o describe el tipo de contenido.',
              options: { example: 'Recepciones' },
            },
            {
              name: 'description',
              title: 'Descripción',
            ...
            },
            {
              ...
              type: 'string',
              description: 'Texto corto que aparece como una etiqueta dentro de la tarjeta.',
              options: { example: 'Recepción' },
            },
            {
              name: 'thumbnail',
